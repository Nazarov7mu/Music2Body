...
class AudoToBodyDynamics(object):
    ...
    def runNetwork(self, validate=False):
        ...
        #loss = torch.nn.SmoothL1Loss(predictions, targets, masks)
        ...
        #frame_loss = torch.nn.SmoothL1Loss(pixel_predictions, pixel_targets, masks)
    ...
    def trainModel(self, max_epochs, logfldr, patience):
        ...
        while(i < max_epochs):
            ...
            log.info("Time to complete the epoch:--- %s seconds ---" % (time.time() - start_time))
