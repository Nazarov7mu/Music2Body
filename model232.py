...
class AudioToKeypointRNN(nn.Module):
    ...
    def __init__(self, options):
        ...
        self.LSTMs = [self.lstm, self.lstm1, self.lstm2]
    ...
    def forward(self, inputs):
        ...
        output_after_lstm2 = output_after_lstm2.view(-1, output_after_lstm2.size()[-1])  # flatten before FC
        dped_output = self.dropout(output_after_lstm2)
        fc1 = self.fc_1(output_after_lstm2)
        #fc2 = self.fc_2(fc1)
